...
<body>
    ...
    <div class="container emp-profile bg-dark">
        <form method="post">
            ...
            <input type="hidden" name="userdata_user_background" id="userdata_user_background" value="${user_background}">
            <input type="hidden" name="userdata__csrf_token_profile_edit" id = "userdata__csrf_token_profile_edit" value="${_csrf_token_profile_edit}">
            <div class="row">
                <div class="col-md-4">
        ...
        <form method="post">
            ...
            <input type="hidden" name="password_user_background" id="password_user_background" value="${user_background}">
            <input type="hidden" name="_password_csrf_token_profile_edit1" id = "_password_csrf_token_profile_edit1" value="${_csrf_token_profile_edit}">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
        ...
        <form method="post">
            ...
            <input type="hidden" name="delete_user_background" id="delete_user_background" value="${user_background}">
            <input type="hidden" name="_delete_csrf_token_profile_edit" id = "_delete_csrf_token_profile_edit" value="${_csrf_token_profile_edit}">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
